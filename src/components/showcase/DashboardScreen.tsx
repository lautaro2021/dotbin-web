        ...
        <div className="flex h-full bg-gradient-to-br from-slate-50 via-white to-primary-50/30">
            ...
            <div className="flex flex-1 flex-col overflow-hidden p-6">
                ...
                <div className="mb-6 shrink-0">
                    <h1 className="text-2xl font-bold text-slate-800">Hola, Doctor</h1>
                    <p className="text-sm text-slate-500">Resumen de actividad del centro</p>
                </div>
                ...
                <div className="mb-6 grid shrink-0 grid-cols-4 gap-4">
                    {stats.map((stat, index) => (
                        <div
                            key={index}
                            className="glass-panel rounded-2xl p-4 transition-all hover:shadow-lg"
                        >
                ...
                <div className="grid min-h-0 flex-1 grid-cols-2 gap-4 overflow-auto">
                    ...
                    <div className="glass-panel flex flex-col rounded-2xl p-4">
                        <div className="mb-4 flex shrink-0 items-center justify-between">
                            <span className="font-semibold text-slate-800">Ocupación</span>
                    ...
                    <div className="glass-panel flex flex-col rounded-2xl p-4">
                        <div className="mb-4 flex shrink-0 items-center justify-between">
                            <span className="font-semibold text-slate-800">Ingresos Semanales</span>
                    ...
                    <div className="glass-panel flex flex-col rounded-2xl p-4">
                        <div className="mb-4 flex shrink-0 items-center justify-between">
                            <span className="font-semibold text-slate-800">Servicios Más Solicitados</span>
                    ...
                    <div className="glass-panel flex flex-col rounded-2xl p-4">
                        <div className="mb-4 flex shrink-0 items-center justify-between">
                            <span className="font-semibold text-slate-800">Tendencia Mensual</span>
                        ...
                        <div className="mt-3 flex shrink-0 items-center justify-center gap-4 border-t border-slate-100 pt-3">
                            <div className="flex items-center gap-1.5">
                                <div className="h-2 w-2 rounded-full bg-blue-400" />
                                <span className="text-[10px] text-slate-500">Pacientes/mes</span>
                            </div>
                        </div>
                    </div>
                </div>
